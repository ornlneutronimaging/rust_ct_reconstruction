...
/// The config debug mode loads at startup — the VENUS TOF one while the
/// pre-processing steps are being developed; the admin Browse button
/// switches to any other (e.g. `config_venus_white_beam.h5`).
pub const DEFAULT_CONFIG_NAME: &str = "config_venus_tof.h5";
